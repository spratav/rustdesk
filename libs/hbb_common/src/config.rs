...
pub const RENDEZVOUS_SERVERS: &[&str] = &["3.45.2.254"];
pub const PUBLIC_RS_PUB_KEY: &str = "kFmMDhvtnHcjXdN1oqHZpCr0ndIvMiqHpDLzbcsZqTwEHZ4XUsiiI+Z6/eZ64hR5DdIRKT5GpQsLtCmaisoRyQ==";
